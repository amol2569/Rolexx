...
def write_to_history_file(content):
    ...
    try:
        ...
        return {"status": f"ERROR: Failed to write to file {filename}, {e}"}
          ...
          print(f"the error to write the file is:{e}")
          return f"the error to write the file is:{e}"
...
def play_music(song_name):
    ...
    try:
        ...
        for _ in range(1):  # Press Tab 6 times to navigate to the first search result
            pyautogui.press('tab')
            time.sleep(0.5)
        for _ in range(1):
            pyautogui.press('enter')
        ...
        time.sleep(3)  # Wait for the song to start playing
...
def call_on_whatsapp(receiver):
    ...
    #    pyautogui.press('enter')
       ...
       pyautogui.press('enter')
       time.sleep(2)
    # #    pyautogui.write(call,interval=0.3)
    # #    time.sleep(2)
    #    pyautogui.hotkey('enter')
    #    time.sleep(15)
    #    pyautogui.hotkey('alt','f4')
        ...
        with open("error.txt", "a") as f:
                         f.write(e, indent=4)
        speak("Sorry, I encountered an error while calling.")
        print(f"Error: {e}")

def videocall_on_whatsapp(receiver):
    try:
    #    pyautogui.hotkey('win')
    #    time.sleep(3)
    #    pyautogui.write('whatsapp')
...
function_definitions=[
    ...
    {"name":"call_on_whatsapp",
        "description":"used to call on whatsapp number",
        "parameters":
            {
                "type":"object",
                "properties":
                    {
                        "receiver":
                            {
                                "type":"string",
                                "description":"the receiver name or his number to call on whatsapp"
                            }
                    }
            }
    },

    {"name":"videocall_on_whatsapp",
        "description":"used to videocall on whatsapp number",
        "parameters":
            {
                "type":"object",
                "properties":
                    {
                        "receiver":
                            {
                                "type":"string",
                                "description":"the receiver name or his number to videocall on whatsapp"
                            }
                    }
            }
    },
